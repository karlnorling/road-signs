...
const COMMONS_REGISTRY: Record<string, CommonsEntry[]> = {
  ...
  at: [
    { category: 'SVG_road_signs_in_Austria',              signCategory: 'infer' },
  ],
  au: [
  ...
  ba: [
    { category: 'SVG_road_signs_in_Bosnia_and_Herzegovina', signCategory: 'infer' },
  ],
  be: [
  ...
  bg: [
    { category: 'SVG_road_signs_in_Bulgaria',             signCategory: 'infer' },
  ],
  bn: [
  ...
  cy: [
    { category: 'SVG_road_signs_in_Cyprus',               signCategory: 'infer' },
  ],
  ca: [
  ...
  ee: [
    { category: 'SVG_road_signs_in_Estonia',              signCategory: 'infer' },
  ],
  ...
  gr: [
    { category: 'SVG_road_signs_in_Greece',               signCategory: 'infer' },
  ],
  hr: [
    { category: 'SVG_road_signs_in_Croatia',              signCategory: 'infer' },
  ],
  hu: [
    { category: 'SVG_road_signs_in_Hungary',              signCategory: 'infer' },
  ],
  ie: [
  ...
  jp: [
    { category: 'Road_signs_in_Japan',                    signCategory: 'infer' },
  ],
  kr: [
  ...
  lt: [
    { category: 'SVG_road_signs_in_Lithuania',            signCategory: 'infer' },
  ],
  lu: [
  ...
  lv: [
    { category: 'SVG_road_signs_in_Latvia',               signCategory: 'infer' },
  ],
  ma: [
  ...
  mg: [
    ...
    { category: 'SVG_road_signs_in_the_Southern_African_Development_Community',              signCategory: 'infer' },
    { category: 'SVG_warning_road_signs_of_the_Southern_African_Development_Community',      signCategory: 'warning' },
    { category: 'SVG_mandatory_road_signs_of_the_Southern_African_Development_Community',    signCategory: 'mandatory' },
    { category: 'Diagrams_of_road_signs_of_the_Southern_African_Development_Community',      signCategory: 'infer' },
  ],
  my: [
  ...
  mu: [
    { category: 'SVG_road_signs_in_Mauritius',            signCategory: 'infer' },
  ],
  mx: [
  ...
  no: [
    { category: 'SVG_road_signs_in_Norway',               signCategory: 'infer' },
  ],
  nz: [
  ...
  pt: [
    { category: 'SVG_road_signs_in_Portugal',             signCategory: 'infer' },
  ],
  ro: [
    { category: 'SVG_road_signs_in_Romania',              signCategory: 'infer' },
  ],
  th: [
  ...
  rs: [
    { category: 'SVG_road_signs_in_Serbia',               signCategory: 'infer' },
  ],
  sg: [
  ...
  si: [
    { category: 'SVG_road_signs_in_Slovenia',             signCategory: 'infer' },
  ],
  sk: [
    { category: 'SVG_road_signs_in_Slovakia',             signCategory: 'infer' },
  ],
  ua: [
    { category: 'SVG_road_signs_in_Ukraine',              signCategory: 'infer' },
  ],
  uk: [
  ...
  gt: [
    ...
    { category: 'SVG_road_signs_in_the_Central_American_Integration_System', signCategory: 'infer' },
  ],
  hn: [
  ...
  ae: [
    ...
    { category: 'SVG_regulatory_road_signs_of_the_United_Arab_Emirates', signCategory: 'prohibitory' },
  ...
  tm: [
    { category: 'SVG_road_signs_in_Turkmenistan',                        signCategory: 'infer' },
  ],
  tz: [
  ...
  // Batch 4
  ad: [
    { category: 'SVG_road_signs_in_Andorra',                             signCategory: 'infer' },
  ],
  bw: [
  ...
  fj: [
    { category: 'SVG_road_signs_in_Fiji',                                signCategory: 'infer' },
  ],
  gy: [
  ...
  ag: [
    { category: 'Diagrams_of_road_signs_of_Antigua_and_Barbuda',         signCategory: 'infer' },
  ],
  bb: [
    { category: 'SVG_road_signs_in_Barbados',                            signCategory: 'infer' },
  ],
  bs: [
    { category: 'Diagrams_of_road_signs_of_the_Bahamas',                 signCategory: 'infer' },
  ],
  dm: [
    { category: 'Diagrams_of_road_signs_of_Dominica',                    signCategory: 'infer' },
  ],
  gd: [
    { category: 'SVG_road_signs_in_Grenada',                             signCategory: 'infer' },
  ],
  kn: [
    { category: 'SVG_road_signs_in_Saint_Kitts_and_Nevis',               signCategory: 'infer' },
  ],
  lc: [
    { category: 'SVG_road_signs_in_Saint_Lucia',                         signCategory: 'infer' },
  ],
  sr: [
  ...
  vc: [
    { category: 'SVG_road_signs_in_Saint_Vincent_and_the_Grenadines',    signCategory: 'infer' },
  ],
  iq: [
  ...
  pg: [
    { category: 'SVG_road_signs_in_Papua_New_Guinea',                    signCategory: 'infer' },
  ],
  rw: [
  ...
  ao: [
    { category: 'SVG_road_signs_in_Angola',                                                  signCategory: 'infer' },
  ],
  ls: [
...
const extractCode = (title: string): string => {
  ...
  const codeMatch = stripped
    .toUpperCase()
    .match(/\b([A-Z]{1,4}-?\d+(?:[.-]\d+)*[A-Z]{0,2})\b/);
...
const fetchCommonsCategory = async (categoryName: string): Promise<string[]> => {
  ...
  for (let page = 0; page < 20; page++) {
    ...
    if (!res.ok) { console.warn(`  Commons API ${res.status} for ${categoryName}`); break; }
...
const fillCountry = async (cc: string): Promise<void> => {
  ...
  const existingCodes = new Set(
    Object.values(scraped).flat().map((s) => s.code),
  );
...
const ALL_COUNTRIES = Object.keys(COMMONS_REGISTRY).filter(
  (cc) => COMMONS_REGISTRY[cc].length > 0,
);
...
const getCountries = (): string[] => {
  ...
  if (!cc) { console.error('Usage: yarn fill-gaps --country=XX | --all'); process.exit(1); }
